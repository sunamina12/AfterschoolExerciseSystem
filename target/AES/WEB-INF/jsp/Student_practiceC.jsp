...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; width: 100%" id="nav">
    <div class="navbar-header">
        <a class="navbar-brand">选择题练习 - 课后练习系统</a>
    </div>
    <!-- /.navbar-header -->
...
<table class="table table-striped table-bordered">
    <form action="choice/submit" method="post" id="sbmtform" name="sbmtform">
    <c:forEach items="${list}" var="cho" varStatus="status">
        <tr>
        ...
        <div class="modal fade" id="exitModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"/>取消
                        <button type="button" class="btn btn-primary" onclick="window.location.href=('<%=basePath%>student/practiceT')"/>确认
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal -->
        </div>
