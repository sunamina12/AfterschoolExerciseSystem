...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; width: 100%" id="nav">
    <div class="navbar-header">
        <a class="navbar-brand">科目章节练习 - 课后练习系统</a>
    </div>
    <!-- /.navbar-header -->
...
<form action="<%=basePath%>practice/PracticeSbmt" method="post" id="sbmtform" name="sbmtform">
    &nbsp;&nbsp;<h4>选择题：</h4>
    <table class="table table-striped table-bordered">
        <c:forEach items="${choiceList}" var="cho" varStatus="status">
            <tr>
    ...
    &nbsp;&nbsp;<h4>填空题：</h4>
    <table class="table table-striped table-bordered">
        <c:forEach items="${blankList}" var="blk" varStatus="status">
            <tr>
...
<div class="modal fade" id="exitModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"/>取消
                <button type="button" class="btn btn-primary" onclick="window.location.href=('<%=basePath%>student/practiceS')"/>确认
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
