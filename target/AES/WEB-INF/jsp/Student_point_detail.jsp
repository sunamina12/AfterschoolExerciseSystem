        ...
        <div class="row">
            <div class="container">
                ...
                <button type="button" class="btn btn-default"
                        onclick="window.location.href=('<%=basePath%>score/SshowAllScore');">返回 <i class="fa fa-reply"></i></button>
                <br><br>
                <h4>
                    作业编号：${asgn.asgnid}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    学科：${asgn.sbjt}&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <table class="table table-striped table-bordered table-hover" id="table1">
                    ...
                    <c:forEach items="${choList}" var="cho" varStatus="status">
                        <tr>
                            ...
                            <td width="350px"><div class="stemautocut" title="${cho.stem}">${cho.stem}</div></td>
                ...
                <div>注：本页显示的题目顺序与你的作业顺序不一致，作业顺序为随机生成</div>
...
<script type="text/javascript">
    $().ready(function () {
        $.ajax({
            ...
            data:"stuid=" + <%=session.getAttribute("userid")%> + "&asgnid=" + ${asgn.asgnid},
            cache:false,
            dataType:"json",
