...
<head>
    ...
    <title>错题练习（${sbjt}${topic}部分） - 课后练习系统</title>
...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; width: 100%" id="nav">
    <div class="navbar-header">
        <a class="navbar-brand">错题练习（${sbjt}${topic}部分） - 课后练习系统</a>
    </div>
    <!-- /.navbar-header -->
...
<form action="<%=basePath%>wrong/SbmtWngBysbjt" method="post" id="sbmtform" name="sbmtform">
    &nbsp;&nbsp;<h4>选择题：</h4>
...
<div class="modal fade" id="exitModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"/>取消
                <button type="button" class="btn btn-primary" onclick="window.location.href=('<%=basePath%>wrong/errorS')"/>确认
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
