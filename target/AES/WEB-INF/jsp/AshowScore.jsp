                ...
                <table id="table" class="table table-striped table-bordered table-hover">
                    ...
                    <c:forEach items="${list}" var="score" varStatus="status">
                        <tr>
                            ...
                            <td><div title="${score.stuid}">${score.stuid}</div></td>
                            ...
                            <td width="1px"><button class="btn btn-info" id="detail${status.index}"
                                                    onclick="window.location.href=('<%=basePath%>score/AshowDetail/${score.asgnid}/${score.stuid}')"/>查看详细 <i class="fa fa-search"></i>
                            </td>
                            <td width="1px"><button class="btn btn-danger" data-toggle="modal" data-target="#delModal" id="del"
                                                    onclick="opendel('${score.id}')"/>删除 <i class="fa fa-times"></i>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="return deleteScoreCon($('#hidden').val())"/>确认
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal -->
        </div>
...
<!-- 确认删除 -->
<script>
    function deleteScoreCon(id) {
        window.location.href=('<%=basePath%>score/AdeleteScore/'+id);
        return true;
    }
</script>
