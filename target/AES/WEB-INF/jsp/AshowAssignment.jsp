            ...
            <div class="container">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th style="text-align:center;">上传者ID</th>
                    ...
                    <c:forEach items="${list}" var="asgn">
                        <tr>
                            ...
                            <td><div title="${asgn.uploader}">${asgn.uploader}</div></td>
                            <td width="1px"><button class="btn btn-info" id="detail"
                                                    onclick="window.location.href=('<%=basePath%>assignment/AshowDetail/'+${asgn.asgnid});"/>查看详细 <i class="fa fa-search"></i>
                            </td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered">
                                <form action="AaddAssignment/addAsgnCom" method="post" id="addform" name="addform">
                                    <tr>
            ...
            <div class="modal fade" id="updtModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered">
                                <form action="AupdateAssignment/updateAsgnCom" method="post" id="updtform" name="updtform">
                                    <tr>
...
<script>
    function deleteAsgnCon(id) {
        window.location.href=('<%=basePath%>assignment/AdeleteAssignment/'+id);
        return true;
    }
</script>
