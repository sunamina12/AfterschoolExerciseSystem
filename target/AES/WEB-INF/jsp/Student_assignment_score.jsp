...
<center>
    <br><br>
    <h2>本次作业正确率 ${score} % ，共 ${total} 题</h2><br>
    <h2>选择题共 ${chototal} 题，回答了 ${choAnswered} 题，${choCorrect} 题回答正确<br><br>
        填空题共 ${blktotal} 题，回答了 ${blkAnswered} 题，${blkCorrect} 题回答正确</h2><br>
    <h2>请访问成绩查看页面了解具体信息</h2>
</center>
</body>
