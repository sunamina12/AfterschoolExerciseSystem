                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered">
                                <form action="TaddChoice/addChoCom" method="post" id="addform" name="addform">
                                    <tr>
            ...
            <div class="modal fade" id="updtModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered">
                                <form action="TupdateChoice/updatechoCom1" method="post" id="updtform" name="updtform">
                                    <tr>
...
<script>
    function deleteChoCon(id) {
        window.location.href=('<%=basePath%>choice/TdeleteChoice/'+id);
        return true;
    }
</script>
        ...
        $("#subaddform").click(
            function () {
                ...
                if ($.trim(sbjt) == ''||$.trim(topic) == ''||$.trim(stem) == ''||$.trim(a) == ''
                    ...
                    var url = "<%=basePath%>choice/Taddchoice/choIdExist";
...
<script>
    function openupdt(param) {
        ...
        $.ajax({
            type: "POST",
            url: "<%=basePath%>/choice/TupdtChoice/getid",
            cache: false,
            dataType: "json",
            data: "choid=" + a,
