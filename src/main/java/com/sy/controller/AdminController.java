...
public class AdminController {
    ...
    public String stuManagement() { return "redirect:/Astudent/showAllStudent"; }

    //跳转至教师管理页面
    @RequestMapping("/tchManagement")
    public String tchManagement() {
        return "redirect:/Ateacher/showAllTeacher";
    }
    ...
    public String blkManagement() {
        return "redirect:/blank/AshowAllBlank";
    }
}
