        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <br>
                    <input type="button" name="submit" id="submit" value="登录" class="btn btn-lg btn-primary btn-block">
                    <br>
                    <a href="<%=basePath%>login/register">还没有账号？去注册（仅学生）</a>
                    <br><br>
        ...
        $("#submit").click(
            function () {
                ...
                if ($.trim(id) == '' || $.trim(pwd) == '') {
                    ...
                    var url = "<%=basePath%>login/home/validateLogin";
                    ...
                    $.post(url, args,
                        function (data) {
                            if ($.trim(data) == "error") {
                                ...
                                flag = false;
                            } else if ($.trim(data) == "adminSuccess") {
                                window.location.href = "<%=basePath%>admin/home";
                                flag = true;
                            } else if ($.trim(data) == "stuSuccess") {
                                window.location.href = "<%=basePath%>student/home";
                                flag = true;
                            } else if ($.trim(data) == "tchSuccess") {
                                window.location.href = "<%=basePath%>teacher/home";
                                flag = true;
                            }
                        })
                }
