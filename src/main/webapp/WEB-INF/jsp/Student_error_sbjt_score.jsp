...
<center>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody>
        <c:forEach items="${choCorrectList}" var="cho">
            <tr>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <c:forEach items="${blkCorrectList}" var="blk">
            <tr>
                <td width="250px"><div class="stemautocut1" title="${blk.stem}">${blk.stem}</div></td>
                <td width="200px"><div class="answerautocut1" title="${blk.answer}">${blk.answer}</div></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
