...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; width: 100%" id="nav">
    <div class="navbar-header">
        <a class="navbar-brand">填空题练习 - 课后练习系统</a>
    </div>
    <!-- /.navbar-header -->
...
<table class="table table-striped table-bordered">
    <form action="blank/submit" method="post" id="sbmtform" name="sbmtform">
        <c:forEach items="${list}" var="blk" varStatus="status">
            <tr>
