...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="container">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addModal" id="add">添加学生 <i class="fa fa-plus"></i></button>
                <br><br>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="return deleteStuCon($('#hidden').val())"/>确认
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal -->
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered">
                                <form action="addStudent/addStuCom" method="post" id="addform" name="addform">
                                    <tr>
                                        <td>学号<font color='red'>* (不可修改)</font></td>
                                        <td><input type="text" size="20" name="stuid1" id="stuid1" class="form-control" AUTOCOMPLETE="OFF"></td>
                                    </tr>
                                    <tr>
                                        <td>姓名<font color='red'>*</font></td>
                                        <td><input type="text" size="20" name="stuname1" id="stuname1" class="form-control" AUTOCOMPLETE="OFF"></td>
                                    </tr>
                                    <tr>
                                        <td>班级<font color='red'>*</font></td>
                                        <td><input type="text" size="20" name="classid1" id="classid1" class="form-control" AUTOCOMPLETE="OFF"></td>
                                    </tr>
                                    <tr>
            ...
            <div class="modal fade" id="updtModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered">
                                <form action="updateStudent/updateStuCom1" method="post" id="updtform" name="updtform">
                                    <tr>
                                        <input type="hidden" name="id2" id="id2">
                                        <td>学号<font color='red'>* (不可修改)</font></td>
                                        <td><input type="text" size="20" name="stuid2" id="stuid2" class="form-control" readonly></td>
                                    </tr>
                                    <tr>
                                        <td>姓名<font color='red'>*</font></td>
                                        <td><input type="text" size="20" name="stuname2" id="stuname2" class="form-control" AUTOCOMPLETE="OFF"></td>
                                    </tr>
                                    <tr>
                                        <td>班级<font color='red'>*</font></td>
                                        <td><input type="text" size="20" name="classid2" id="classid2" class="form-control" AUTOCOMPLETE="OFF"></td>
                                    </tr>
                                    <tr>
                                        <td class="last">所属专业<font color='red'>*</font></td>
...
<script>
    function deleteStuCon(id) {
        window.location.href=('<%=basePath%>Astudent/deleteStudent/'+id);
        return true;
    }
</script>
    ...
    $(function () {
        ...
        $("#subaddform").click(
            function () {
                ...
                if ($.trim(id) == ''||$.trim(stuname) == ''||$.trim(classid) == ''||$.trim(major) == '') {
                    $("#userspan1").html("<font color='red'>不能提交空信息</font>");
                    flag = false;
                } else if($.trim(id).length != 8 || $.trim(classid).length != 7){
                    $("#userspan1").html("<font color='red'>学号应为8位数字，班级应为7位数字</font>");
                    flag = false;
                } else {
                    var url = "<%=basePath%>Astudent/addStudent/stuIdExist";
                    var args = { "id": $.trim(id) };
                    $.post(url, args,
                        function (data) {
                            if ($.trim(data) == "error") {
                                $("#userspan1").html("<font color='red'>学号已存在</font>");
                                flag = false;
...
<script>
    function openupdt(param) {
        ...
        $.ajax({
            type: "POST",
            url: "<%=basePath%>/Astudent/updtStudent/getid",
            cache: false,
            dataType: "json",
            data: "stuid=" + a,
            success: function (data) {
                ...
                if(itemed=="计算机科学与技术"){
                    item=1;
                }else if(itemed=="计算机科学与技术（电气方向）"){
                    item=2;
                }else if(itemed=="计算机科学与技术（创新创业）"){
                    item=3;
                }else if(itemed=="软件工程"){
                    item=4;
                }else if(itemed=="信息安全"){
    ...
    $(function () {
        ...
        $("#subupdtform").click(
            function () {
                ...
                if ($.trim(stuname) == ""||$.trim(classid) == ""||$.trim(major) == "") {
                    $("#userspan2").html("<font color='red'>不能提交空信息</font>");
                    flag = false;
                } else if($.trim(classid).length != 7){
                    $("#userspan2").html("<font color='red'>班级应为7位数字</font>");
                    flag = false;
                } else {
                    $("#updtform").submit();
                    return true;
