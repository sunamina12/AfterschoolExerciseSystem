                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered">
                                <form action="AaddBlank/addBlkCom" method="post" id="addform" name="addform">
                                    <tr>
            ...
            <div class="modal fade" id="updtModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered">
                                <form action="AupdateBlank/updateblkCom1" method="post" id="updtform" name="updtform">
                                    <tr>
...
<script>
    function deleteblkCon(id) {
        window.location.href=('<%=basePath%>blank/AdeleteBlank/'+id);
        return true;
    }
</script>
        ...
        $("#subaddform").click(
            function () {
                ...
                if ($.trim(sbjt) == ''||$.trim(topic) == ''||$.trim(stem) == ''||$.trim(answer) == '') {
                    ...
                    var url = "<%=basePath%>blank/Aaddblank/blkIdExist";
...
<script>
    function openupdt(param) {
        ...
        $.ajax({
            type: "POST",
            url: "<%=basePath%>/blank/AupdtBlank/getid",
            cache: false,
            dataType: "json",
            data: "blkid=" + a,
